...
import ContactBar from "./contact-stickbar";
  ...
  return (
   ...
   <ContactBar/>
    <div className="p-6">
      ...
      <GalleriesComponent excludeCategory={category} sectionTitle="Explore Other Projects" gridColumnsClass="grid-cols-1 md:grid-cols-2 lg:grid-cols-3" />
      </div>
    </div>
